      ...
      <div className="container px-4 md:px-6 mx-auto max-w-6xl">
        ...
        >
          ...
          <div className="p-8 text-gray-200">
            ...
            <motion.div
              className="bg-black rounded-lg p-8 border border-gray-800"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <div className="flex flex-col sm:flex-row gap-8 items-center">
                <motion.div
                  className="h-36 w-36 rounded-full bg-black flex-shrink-0 flex items-center justify-center text-white text-4xl font-bold border-2 border-white"
                ...
                <div className="flex-1">
                  ...
                  <motion.div
                    className="bg-black rounded-lg p-6 mb-6 border border-gray-800"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      <h4 className="text-white font-semibold mb-2 text-lg">Expertise</h4>
                      <p className="text-gray-300">Web3, DApps, UI/UX, Front-end</p>
                    </motion.div>
                    <motion.div
                      className="bg-black rounded-lg p-5 border border-gray-700"
                      whileHover={{ y: -5 }}
                    ...
                    >
                      <h4 className="text-white font-semibold mb-2 text-lg">Focus</h4>
                      <p className="text-gray-300">Minimalism, Digital Art, NFTs</p>
                    </motion.div>
                  </div>
                </div>
              </div>
