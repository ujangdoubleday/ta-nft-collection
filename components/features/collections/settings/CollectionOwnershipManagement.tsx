...
import { CurrentCollectionOwnership } from './CurrentCollectionOwnership';
import { TransferCollectionOwnership } from './TransferCollectionOwnership';
import { RenounceCollectionOwnership } from './RenounceCollectionOwnership';

interface CollectionOwnershipManagementProps {
  address: string;
  isLoading: boolean;
  role?: 'admin' | 'user';
}

export function CollectionOwnershipManagement({
  address,
  isLoading,
  role = 'user',
}: CollectionOwnershipManagementProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="flex flex-col gap-6">
        <CurrentCollectionOwnership collectionAddress={address} isLoading={isLoading} />
      </div>
