...
-- AddForeignKey
ALTER TABLE "Collection" ADD CONSTRAINT "Collection_ownerAddress_fkey" FOREIGN KEY ("ownerAddress") REFERENCES "User"("address") ON DELETE RESTRICT ON UPDATE CASCADE;
