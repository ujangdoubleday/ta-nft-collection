...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetOmit<
      'id' | 'address' | 'createdAt' | 'updatedAt' | 'name' | 'email' | 'emailVerified' | 'image',
      ExtArgs['result']['user']
    >;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    nfts<T extends User$nftsArgs<ExtArgs> = {}>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions> | Null
    >;
  ...
  export type NFTSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetSelect<
      {
        id?: boolean;
        tokenId?: boolean;
  ...
  export type NFTSelectCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type NFTSelectUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetSelect<
    {
      id?: boolean;
  ...
  export type NFTOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetOmit<
      | 'id'
      | 'tokenId'
      | 'name'
  ...
  export type NFTIncludeCreateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    owner?: boolean | UserDefaultArgs<ExtArgs>;
  };
  export type NFTIncludeUpdateManyAndReturn<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    owner?: boolean | UserDefaultArgs<ExtArgs>;
  };
  ...
  type NFTGetPayload<S extends boolean | null | undefined | NFTDefaultArgs> = $Result.GetResult<
    Prisma.$NFTPayload,
    S
  >;

  type NFTCountArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = Omit<
    NFTFindManyArgs,
    'select' | 'include' | 'distinct' | 'omit'
  > & {
  ...
  > {
     ...
     * })
     */
    findUnique<T extends NFTFindUniqueArgs>(
      args: SelectSubset<T, NFTFindUniqueArgs<ExtArgs>>,
    ): Prisma__NFTClient<
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'findUnique', GlobalOmitOptions> | null,
      null,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    findUniqueOrThrow<T extends NFTFindUniqueOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'findUniqueOrThrow', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
     ...
     * })
     */
    findFirst<T extends NFTFindFirstArgs>(
      args?: SelectSubset<T, NFTFindFirstArgs<ExtArgs>>,
    ): Prisma__NFTClient<
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'findFirst', GlobalOmitOptions> | null,
      null,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    findFirstOrThrow<T extends NFTFindFirstOrThrowArgs>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'findFirstOrThrow', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    findMany<T extends NFTFindManyArgs>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions>
    >;
    ...
    create<T extends NFTCreateArgs>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'create', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
     ...
     *
     */
    createManyAndReturn<T extends NFTCreateManyAndReturnArgs>(
      args?: SelectSubset<T, NFTCreateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'createManyAndReturn', GlobalOmitOptions>
    >;
    ...
    delete<T extends NFTDeleteArgs>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'delete', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
    ...
    update<T extends NFTUpdateArgs>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'update', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
     ...
     *
     */
    updateManyAndReturn<T extends NFTUpdateManyAndReturnArgs>(
      args: SelectSubset<T, NFTUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'updateManyAndReturn', GlobalOmitOptions>
    >;
    ...
    upsert<T extends NFTUpsertArgs>(
      ...
      $Result.GetResult<Prisma.$NFTPayload<ExtArgs>, T, 'upsert', GlobalOmitOptions>,
      never,
      ExtArgs,
      GlobalOmitOptions
    >;
     ...
     * })
     **/
    aggregate<T extends NFTAggregateArgs>(
      args: Subset<T, NFTAggregateArgs>,
    ): Prisma.PrismaPromise<GetNFTAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, NFTGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors ? GetNFTGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export interface Prisma__NFTClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
   ...
   */
  export type NFTCreateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the NFT
   ...
   */
  export type NFTUpdateManyAndReturnArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the NFT
  ...
  export type TodoOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> =
    $Extensions.GetOmit<
      'id' | 'title' | 'description' | 'completed' | 'authorName' | 'createdAt' | 'updatedAt',
      ExtArgs['result']['todo']
    >;
  ...
  interface TodoFieldRefs {
    ...
    readonly authorName: FieldRef<'Todo', 'String'>;
  ...
  export type NFTWhereUniqueInput = Prisma.AtLeast<
    {
      id?: string;
      tokenId_contractAddress?: NFTTokenIdContractAddressCompoundUniqueInput;
      AND?: NFTWhereInput | NFTWhereInput[];
      OR?: NFTWhereInput[];
      NOT?: NFTWhereInput | NFTWhereInput[];
      tokenId?: StringFilter<'NFT'> | string;
  ...
  export type TodoWhereInput = {
    ...
    authorName?: StringFilter<'Todo'> | string;
  ...
  export type TodoScalarWhereWithAggregatesInput = {
    ...
    authorName?: StringWithAggregatesFilter<'Todo'> | string;
  ...
  export type NFTCreateNestedManyWithoutOwnerInput = {
    create?:
      | XOR<NFTCreateWithoutOwnerInput, NFTUncheckedCreateWithoutOwnerInput>
      | NFTCreateWithoutOwnerInput[]
      | NFTUncheckedCreateWithoutOwnerInput[];
  ...
  export type CollectionCreateNestedManyWithoutOwnerInput = {
    create?:
      | XOR<CollectionCreateWithoutOwnerInput, CollectionUncheckedCreateWithoutOwnerInput>
  ...
  export type NFTUpdateManyWithoutOwnerNestedInput = {
    ...
    connectOrCreate?: NFTCreateOrConnectWithoutOwnerInput | NFTCreateOrConnectWithoutOwnerInput[];
    upsert?:
      | NFTUpsertWithWhereUniqueWithoutOwnerInput
      | NFTUpsertWithWhereUniqueWithoutOwnerInput[];
    createMany?: NFTCreateManyOwnerInputEnvelope;
    ...
    connect?: NFTWhereUniqueInput | NFTWhereUniqueInput[];
    update?:
      | NFTUpdateWithWhereUniqueWithoutOwnerInput
      | NFTUpdateWithWhereUniqueWithoutOwnerInput[];
    updateMany?:
      | NFTUpdateManyWithWhereWithoutOwnerInput
      | NFTUpdateManyWithWhereWithoutOwnerInput[];
  ...
  export type UserUpdateOneRequiredWithoutCollectionsNestedInput = {
    ...
    connect?: UserWhereUniqueInput;
    update?: XOR<
      XOR<UserUpdateToOneWithWhereWithoutCollectionsInput, UserUpdateWithoutCollectionsInput>,
