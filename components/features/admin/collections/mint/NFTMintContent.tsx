...
export function NFTMintContent({ contractAddress }: NFTMintContentProps) {
  ...
  if (error || !isValid) {
    ...
    return <ErrorState contractAddress={contractAddress} error={errorObj} />;
  }

  if (mintingState.mintSuccess) {
    return <MintSuccess contractAddress={contractAddress} onMintAnother={mintingState.resetForm} />;
  }

  return (
    <>
      <NFTMintHeader collectionName={collectionName} contractAddress={contractAddress} />
