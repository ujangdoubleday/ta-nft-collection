        ...
        <>
          ...
          <div className="flex flex-col mt-4">
            <div className="p-3 mb-4 bg-[#c0c0c0] border-[1px] border-t-[#808080] border-l-[#808080] border-r-white border-b-white text-xs">
              ...
              <p className="mb-2">
                <strong>Network:</strong> <span>{getNetworkNameAction(chainId)}</span>
              </p>
              <p>
    ...
    case 'checking':
      return (
        <>
          ...
          <div className="flex flex-col mt-4">
            <div className="p-3 mb-4 bg-[#c0c0c0] border-[1px] border-t-[#808080] border-l-[#808080] border-r-white border-b-white text-sm">
              <p className="mb-2 text-center">Signing for wallet confirmation...</p>
          ...
          <div className="flex flex-col mt-4">
            <div className="p-3 mb-4 bg-[#c0c0c0] border-[1px] border-t-[#808080] border-l-[#808080] border-r-white border-b-white">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs">{getNetworkNameAction(chainId)}</span>
              </div>
